    ...
    return (
        <section className="relative mt-[5rem] sm:mt-[7rem] ">
            ...
            <div className="mx-auto max-w-6xl flex flex-col items-center align-center text-center px-5 md:px-10">
                ...
                <div className="text-sm md:text-xl text-base text-gray-700 mb-[3rem] md:mb-[5rem]" data-aos="zoom-y-out" data-aos-delay="300">The Art Critique Platform is Coming Soon</div>
